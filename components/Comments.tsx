...
const Comments = ({comment,setComment,addComment,comments,isPostingComment}:IProps) => {
  ...
  return (
    <div className="border-r-2 border-gray-200 pt-4 px-10 bg-[#f8f8f8] brder-b-2 lg:pb-0 pb-[100px]">
      ...
      {userProfile && (
        <div className='absolute bottom-0 left-0 pb-6 px-2 md:px-10'>
          <form onSubmit={addComment} className="flex gap-4">
            ...
            <button onClick={addComment} className='text-md text-gray-400'>{isPostingComment ? 'Commenting...' : 'Comment'}</button>
          </form>
