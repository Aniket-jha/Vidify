...
const Discover = () => {
  ...
  const activeTopicStyle = "xl:border-2 hover:bg-primary xl:border-[#590f84] px-3 py-2 rounded xl:rounded-full flex items-center gap-2 justify-center cursor-pointer  text-[#590f84]"
